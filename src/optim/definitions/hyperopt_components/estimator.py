...
from sklearn.cross_validation import KFold, StratifiedKFold, LeaveOneOut, ShuffleSplit, StratifiedShuffleSplit, PredefinedSplit
    ...
    try:
        ...
        for train_index, valid_index in cv_iter:
            ...
            if loss_fn is None:
                ...
                lossvar = None
                info('OK trial with loss %.5f' % loss)
            t_done = time.time()
            rval = {
                'loss': loss,
